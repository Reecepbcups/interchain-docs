...
const organizationName = "reecepbcups";
const projectName = "interchain-docs";
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: "https://github.com/reecepbcups/interchain-docs",
